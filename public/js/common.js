...
(function () {
    ...
    box.innerHTML =
      ...
      '<div class="social-grid">' +
        links.map(function (l) {
          return '<a class="social-btn" href="' + esc(l.url) + '" target="_blank" rel="noopener">' +
  ...
  function renderFooterSocial(links) {
    ...
    row.innerHTML =
      ...
      links.map(function (l) {
        return '<a href="' + esc(l.url) + '" target="_blank" rel="noopener" title="' + esc(l.name) + '" aria-label="' + esc(l.name) + '">' +
          (SOCIAL_ICONS[l.id] || '') + '</a>';
      }).join('');
